...
<template>
  <div class="flex">
    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-100 lg:translate-x-0 lg:static lg:inset-0 border border-gray-300">
      <div class="flex items-center justify-center mt-8">
        <span class="mx-2 text-2xl font-semibold text-black">CHATTER</span>
      </div>

      <nav class="mt-10 text-black">
        <div class="px-6 py-2 mt-4 duration-200">
          <h3 class="text-[#111111]">Overview</h3>
          <div>
            <router-link class="flex items-center px-6 py-2 mt-4 duration-200" :class="route.name == 'dashboard' ? 'text-blue-700 hover:text-opacity-50' : ' text-gray-500 hover:text-blue-700'
              " to="/dashboard">
              ...
              <span class="mx-4">Feed</span>
            </router-link>
            <router-link class="flex items-center px-6 py-2 mt-4 duration-200"
              :class="route.name == 'bookmarks' ? 'text-blue-700 hover:text-opacity-50' : ' text-gray-500 hover:text-blue-700'"
              to="/bookmarks">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <span class="mx-4">Booksmarks</span>
            </router-link>
            <router-link class="flex items-center px-6 py-2 mt-4 duration-200"
              :class="route.name == 'blogs' ? 'text-blue-700 hover:text-opacity-50' : ' text-gray-500 hover:text-blue-700'"
              to="/blogs">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <span class="mx-4">Team blogs</span>
            </router-link>
            <router-link class="flex items-center px-6 py-2 mt-4 duration-200"
              :class="route.name == 'drafts' ? 'text-blue-700 hover:text-opacity-50' : ' text-gray-500 hover:text-blue-700'"
              to="/drafts">
            ...
            <router-link class="flex items-center px-6 py-2 mt-4 duration-200"
              :class="route.name == 'analytics' ? 'text-blue-700 hover:text-opacity-50' : ' text-gray-500 hover:text-blue-700'"
              to="/analytics">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="px-6 py-2 mt-4 duration-200">
          <h3 class="text-[#111111]">Trending tags</h3>
          <div>
...
// const { activeClass, inactiveClass } = useTailwindConfig();
...
//   return ' border-gray-900 text-black text-opacity-50 hover:text-blue-700 hover:text-opacity-50 hover:text-gray-100';
// });
