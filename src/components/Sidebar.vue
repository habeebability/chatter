        ...
        <div class="px-6 py-2 mt-4 duration-200">
          ...
          <div>
            <router-link
              ...
              :class="[$route.path === '/dashboard' ? activeClass : inactiveClass]"
              to="/dashboard"
            >
              <svg
                width="24"
        ...
        <div class="px-6 py-2 mt-4 duration-200">
          ...
          <div>
            <router-link
              v-for="tag in tags"
              :key="tag.id"
              class="flex items-center px-3 py-2 mt-4 duration-200"
              :class="[$route.path === '/tags' ? activeClass : inactiveClass]"
              to="/dashboard"
            >
              <!-- <svg
                class="w-5 h-5"
