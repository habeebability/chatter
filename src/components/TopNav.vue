...
<template>
  <header class="flex items-center justify-between lg:justify-around px-3 py-4 bg-gray-50 border-b border-[#D0D0D0]">
    <div class="flex items-center lg:w-3/8">
      ...
      <div class="relative mx-4 lg:mx-0">
        ...
        <input
          class="w-full pl-10 py-3 pr-4 text-indigo-600 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
          type="text" placeholder="Search chatter" />
      </div>
    </div>
    ...
    <div class="flex items-center">
      ...
      <div class="relative">
        <button class="relative z-10 block w-8 h-8 overflow-hidden rounded-full shadow focus:outline-none"
          ...
          <img class="object-cover w-full h-full" src="../assets/images/user-avatar.png" alt="Your avatar" />
        </button>
